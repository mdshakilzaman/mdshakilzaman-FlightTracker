...
public class FlightDAO {
    ...
    public List<Flight> getAllFlights(){
        ...
        try {
            ...
            String sql = "SELECT * FROM flight;"; //changed here
    ...
    public Flight getFlightById(int id){
        ...
        try {
            //Write SQL logic here
            String sql = "SELECT * FROM flight WHERE flight_id = ?;"; //changed here
            
            PreparedStatement preparedStatement = connection.prepareStatement(sql);

            //write preparedStatement's setString and setInt methods here.
            preparedStatement.setInt(1, id); // changed here
    ...
    public Flight insertFlight(Flight flight){
        ...
        try {
            ...
            String sql = "INSERT INTO flight (departure_city, arrival_city) VALUES (?, ?);" ; //changed here
            PreparedStatement preparedStatement = connection.prepareStatement(sql, Statement.RETURN_GENERATED_KEYS);

            //write preparedStatement's setString and setInt methods here.
            preparedStatement.setString(1, flight.getDeparture_city()); //changed here
            preparedStatement.setString(2, flight.getArrival_city()); //changed here
    ...
    public void updateFlight(int id, Flight flight){
        ...
        try {
            //Write SQL logic here
            String sql = "update flight SET departure_city=?, arrival_city=? where flight_id = ?;"; //changed here
            PreparedStatement preparedStatement = connection.prepareStatement(sql);

            //write PreparedStatement setString and setInt methods here.
            preparedStatement.setString(1,flight.getDeparture_city()); //changed here
            preparedStatement.setString(2,flight.getArrival_city()); //changed here
            preparedStatement.setInt(3,id); //changed here
    ...
    public List<Flight> getAllFlightsFromCityToCity(String departure_city, String arrival_city){
        ...
        try {
            //Write SQL logic here
            String sql = "select * from flight where departure_city = ? and arrival_city = ?;"; //changed here
            PreparedStatement preparedStatement = connection.prepareStatement(sql);

            //write PreparedStatement setString and setInt methods here.
            preparedStatement.setString(1, departure_city); //changed here
            preparedStatement.setString(2, arrival_city); //changed here
